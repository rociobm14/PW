    ...
    <body>
        ...
        <main>
            ...
            <?php
                ...
                $consultaSQL = "SELECT * FROM Imagenes WHERE id = $id";
                ...
                if($id == 26){
                    ...
                    echo '<a href="obra.php?id=6">Corona de corales</a>';
                    echo '<a href="obra.php?id=9">Melena vibrante rosácea</a>';
                    echo '<a href="obra.php?id=10">El pío de la mañana</a>';
                    echo '</nav>';
                    echo '</aside>';

    ...
    <body>
        ...
        <main id="colecciones_generales">
            ...
            <?php
                ...
                $consultaSQL = "SELECT * FROM Imagenes WHERE id BETWEEN 19 AND 27";
                ...
                if($imagenes){
                    ...
                    echo '<nav>';
                    echo '<a href="siguientes_generales.php">Anterior</a>';
                    echo '<a href="siguientes_generales3.php">Siguiente</a>';
                    echo '</nav>';
                    echo '</section>';
                }

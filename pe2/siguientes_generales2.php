...
<html lang="es">
    <head>
        <title>Colección de obras de arte siguientes general 2</title>
    ...
    <body>
        ...
        <main id="colecciones_generales">
            ...
            <section id="obras">
                <h2>Obras de arte siguientes de toda la colección</h2>
                ...
                <section id="siguientes">
                    <nav>
                        <a href="siguientes_generales.php">Anterior</a>
                        <a href="coleccion.php">Siguiente</a>
                    </nav>
                </section>
            </section>
        </main>

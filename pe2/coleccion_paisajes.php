...
<html lang="es">
    <head>
        <title>Colección de obras de arte paisajes</title>
    ...
    <body>
        ...
        <main id="colecciones_generales">
            ...
            <section id="obras">
                <h2>Obras de arte de Paisajes</h2>
                    ...
                    <article>
                        <figure>
                            ...
                            <figcaption>
                                ...
                                <p>Autora: <cite>Eva BE</cite></p>
                                <time datetime="2020-04-15">Fecha: <cite>25-04-2020</cite></time>
                            </figcaption>
                        </figure> 
                    </article>
                ...
                <section id="siguientes">
                    <nav>
                        <a href="siguientes_paisajes.php">Siguiente</a>
                    </nav>
                </section>
            </section>
        </main>
